...
void shoot_on(u32 value)
{
	...
	//射门力度曲线校正，用shoot_power_curve_b和shoot_power_curve_a计算
	value = shoot_power_curve_a + (shoot_power_curve_b - shoot_power_curve_a)* value / MAX_SHOT_STRENGTH;
...
void set_dribbler(u16 value, u8 dir)
{
	...
	TIM_SetCompare1(TIM11, value * dribbler_power_amp);
}
